    ...
    <div class="row justify-content-center">
      <div class="col-lg-6 px-4 pb-4" id="order">
        ...
        <div class="jumbotron p-3 mb-2 text-center">
          ...
          <h6 class="lead"><b>Delivery Charge : </b>+- R21</h6>
        ...
        <form action="" method="post" id="placeOrder">
          ...
          <div class="form-group">
            <input type="text" name="name" class="form-control" placeholder="Enter The Name for Delivery" required>
          </div>
          <div class="form-group">
            <input type="email" name="email" class="form-control" placeholder="Enter E-Mail for Receipt" required>
          </div>
          <div class="form-group">
